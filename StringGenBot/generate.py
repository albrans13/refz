...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    try:
        phone_code_msg = None
        if not is_bot:
            phone_code_msg = await bot.ask(user_id, "**- قم بارسـال الكود الذي وصل اليك من الشركة - اضغـط الـزر بالاسفـل لـ الذهاب لـ اشعـاراتTelegram  - أرسـل كود الدخول بالتنسيق التالي : - اذا كان الكـود هـو 12345 - يرجى ارساله هكـذا  1 2 3 4 5 - مع وجود مسـافـات بين الارقـام .**[اضـغـط هـنـا](tg://openmessage?user_id=777000)", filters=filters.text, timeout=600)
    ...
    await bot.send_message(msg.chat.id, "**- تم استخـراج كـود جلسـة ᴛᴇʟᴇᴛʜᴏɴ .. بنجـاح ✅\n- تم ارسـال الكـود لحافظـة حسـابـك للامـان 😇\n\n- اضغـط الـزر بالاسفـل للانتقـال لحافظـة حسابك**/n[اضـغـط هـنـا](tg://openmessage?user_id=owner_id)**".format("ᴛᴇʟᴇᴛʜᴏɴ" if telethon else "ᴩʏʀᴏɢʀᴀᴍ"))
